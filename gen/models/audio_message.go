...
//
// swagger:model AudioMessage
type AudioMessage struct {

	// Fully qualified url
	// Required: true
	// Format: uri
	Audio *strfmt.URI `json:"audio"`
...
// Validate validates this audio message
func (m *AudioMessage) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AudioMessage) validateAudio(formats strfmt.Registry) error {

	if err := validate.Required("audio", "body", m.Audio); err != nil {
		return err
	}

	if err := validate.FormatOf("audio", "body", "uri", m.Audio.String(), formats); err != nil {
		return err
	}
...
func (m *AudioMessage) validateNumberReplyIds(formats strfmt.Registry) error {
...
func (m *AudioMessage) validateSessionID(formats strfmt.Registry) error {
...
func (m *AudioMessage) UnmarshalBinary(b []byte) error {
	var res AudioMessage
