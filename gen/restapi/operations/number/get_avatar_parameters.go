...
// NewGetAvatarParams creates a new GetAvatarParams object
// no default values defined in spec.
func NewGetAvatarParams() GetAvatarParams {

	return GetAvatarParams{}
}

// GetAvatarParams contains all the bound params for the get avatar operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetAvatar
...
//
// To ensure default values, the struct must have been initialized with NewGetAvatarParams() beforehand.
func (o *GetAvatarParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAvatarParams) bindPhoneNumber(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAvatarParams) bindSessionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAvatarParams) validateSessionID(formats strfmt.Registry) error {
