...
func (o *ConnectParams) bindSessionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ConnectParams) validateSessionID(formats strfmt.Registry) error {
