...
// NewIsConnectedParams creates a new IsConnectedParams object
// no default values defined in spec.
func NewIsConnectedParams() IsConnectedParams {

	return IsConnectedParams{}
}

// IsConnectedParams contains all the bound params for the is connected operation
// typically these are obtained from a http.Request
//
// swagger:parameters isConnected
type IsConnectedParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewIsConnectedParams() beforehand.
func (o *IsConnectedParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IsConnectedParams) bindSessionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *IsConnectedParams) validateSessionID(formats strfmt.Registry) error {
