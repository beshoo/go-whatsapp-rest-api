...
/*Logout swagger:route POST /profile/logout Profile logout

The user will be logged out with his session cleared from DB, you will need to rescan and reset the webhook to reconnect the user
