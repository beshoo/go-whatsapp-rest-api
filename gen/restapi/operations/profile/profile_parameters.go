...
// ProfileParams contains all the bound params for the profile operation
...
//
// To ensure default values, the struct must have been initialized with NewProfileParams() beforehand.
func (o *ProfileParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ProfileParams) bindSessionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ProfileParams) validateSessionID(formats strfmt.Registry) error {
